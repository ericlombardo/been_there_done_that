...
companions = [Faker::Name.name, Faker::Name.name, Faker::Name.name, Faker::Name.name, Faker::Name.name, Faker::Name.name, Faker::Name.name, Faker::Name.name, Faker::Name.name, Faker::Name.name]
foods = [Faker::Food.vegetables, Faker::Food.vegetables, Faker::Food.vegetables, Faker::Food.fruits, Faker::Food.fruits, Faker::Food.fruits, Faker::Food.fruits, Faker::Food.dish, Faker::Food.dish, Faker::Food.dish, Faker::Food.dish, Faker::Food.dish, Faker::Food.dish, Faker::Food.dish, Faker::Food.dish, Faker::Food.dish, Faker::Food.dish, Faker::Food.dish, Faker::Food.dish, Faker::Food.dish, Faker::Food.dish, Faker::Food.dish, Faker::Food.dish, Faker::Food.dish, Faker::Food.dish, Faker::Food.dish]
notes = ["A tree cannot be straight if it has a crooked trunk. Here we're limited by the time we have. This is your creation - and it's just as unique and special as you are. Automatically, all of these beautiful, beautiful things will happen. When things happen - enjoy them. They're little gifts. That's a crooked tree. We'll send him to Washington.", "Just relax and let it flow. That easy. See there how easy that is. When you do it your way you can go anywhere you choose. If you do too much it's going to lose its effectiveness", "This is unplanned it really just happens. We don't have to be concerned about it. We just have to let it fall where it will. No pressure. Just relax and watch it happen."]
...
admin = User.create(username: "eric", email: "eric@wander.com", password: "codingisawesome")
10.times do
